...
# face_detect = cv2.CascadeClassifier("haarcascade_frontalcafe_default.xml")
face_detect = cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalcafe_defoti.xml")
