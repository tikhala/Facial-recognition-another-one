...
#face_recognizer = cv2.face.EigenFaceRecognizer_crea()
...
face_detect = cv2.CascadeClassifier(
    'Image_processing_projects\Project_5-Real_time_Human_Face_Recognition\haarcascade_frontalface_default.xml')
